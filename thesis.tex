...
%\usepackage[lmargin=default,rmargin=default]{geometry} 
...
\frontmatter
\include{content/front/titlepage_cio}
%\include{content/front/portada_cio_ug} %esta es del cio ug
\include{content/front/abstracto}
%\include{content/front/dedicatoria}
\include{content/front/agradecimientos} % AGRADECIMIENTOS!!!!!!!!!
...
\include{content/main/introduccion}
\include{content/main/marco_teorico}
\include{content/main/desarrollo_experimental}
\include{content/main/resultados}
\include{content/main/conclusiones}

\appendix
\include{content/main/factor_correccion}

\backmatter
%\include{content/back/vita}
\input{content/back/bibliografia}
