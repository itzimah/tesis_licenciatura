...
\section[Diferentes tipos de marcadores fluorescentes]{Diferentes tipos de marcadores fluorescentes: ?`por qu\'e utilizar nanopart\'iculas org\'anicas?}
...
\caption[Puntos cu\'anticos.]{Puntos cu\'anticos. \emph{\scriptsize{Imagen de Benoit Dubertret, 2004}}}\label{fig1}
\end{figure}
...
\section[Nanopart\'iculas org\'anicas funcionalizadas con PEG]{Nanopart\'iculas org\'anicas funcionalizadas con PEG utilizadas como marcadores}
...
\item 2) Estudiar la transferencia de energía de resonancia Förster en suspensiones acuosas de nanopartículas.
