...
Se estudi\'o un grupo de 15 mol\'eculas fluorescentes sintetizados por la Dra. en X Mariana Flores de la Universidad de X; \'estas se basan en una mol\'ecula poliinsaturada con un grupo funcional amida y dos sustituyentes $R$. La estructura molecular y los 15 diferentes sustituyentes se muestran en la figura \ref{muchacha}.

Se trabaj\'o tambi\'en con un copol\'imero de dos bloques conocido como PF2/6-b-P3TMAHT, compuesto por los homopol\'imeros poli(9,9-dialquilfluoreno)-b-poli[3-(6-amoniohexil)tiofeno] (P3TMAHT) y 2-(etil)hexil (PF2/6), el cual contiene unidades de fluoreno. Este copol\'imero, mostrado en la figura \ref{copolimerito}, fue proporcionado por el Dr. Ullrich Scherf de Bergische Universit\"at Wuppertal, Macromolecular Chemistry Group and Institute for Polymer Technology.
...
\begin{figure}[H]
\centering
\includegraphics[width=0.55\textwidth]{capitulo3/copolimero}
...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{capitulo3/arturo}
\caption{Mol\'eculas org\'anicas dipolar, cuadrupolar y octopolar\label{ar2}}
\end{figure}

El pol\'imero PMC300 (Ver Figura \ref{PMC}) est\'a basado en el mon\'omero 4,7-bis[2-(9,9-dimetil)fluorenil]benzo[1,2,5]tiadiazol y contiene varias unidades de fluoreno, la s\'intesis se reporta en la referencia \cite{laura}.
