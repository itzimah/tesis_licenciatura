...
Por otra parte se estudiaron tres sistemas $\pi$ conjugados con diferente distribuci\'on de carga: dipolar 1NDS, cuadrupolar 2NQS y octopolar 3NOS; en la figura \ref{ar2} se muestran las estructuras de estos sistemas basados en unidades de fluoreno. Los pesos moleculares $M_{w}$ son $515.771g/mol$, $905.387 g/mol$ y $1547.312g/mol$ para la mol\'ecula dipolar, cuadrupolar y octopolar respectivamente. Las mol\'eculas fueron dise\~{n}adas y sintetizadas por el Ing. Qu\'imico Arturo Jim\'enez S\'anches y la Dra. Rosa Santill\'an del Departamento de Qu\'imica Cinvestav- IPN.
...
Finalmente se estudio tambi\'en el pol\'imero derivado de fluoreno PMC300 (Ver Figura \ref{PMC}), el cual est\'a basado en el mon\'omero 4,7-bis[2-(9,9-dimetil)fluorenil]benzo[1,2,5]tiadiazol; la s\'intesis se reporta en la referencia \cite{laura}.
...
Cabe mencionar que posterior al paso n\'umero 1, 2 y 4 las c\'elulas fueron lavadas suavemente utilizando PBS. 
