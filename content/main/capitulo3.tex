...
Se utilizaron tres sistemas $\pi$ conjugados con diferente distribuci\'on de carga: dipolar 1NDS, cuadrupolar 2NQS y octopolar 3NDS, cuyas estructuras se muestran en la figura \ref{ar2}. Los pesos moleculares $M_{w}$ son $515.771g/mol$, $905.387 g/mol$ y $1547.312g/mol$ para la mol\'ecula dipolar, cuadrupolar y octopolar respectivamente. Las mol\'eculas fueron sintetizadas por el Ing. Qu\'imico Arturo Jim\'enez S\'anches del Departamento de Qu\'imica Cinvestav- IPN.
...
El pol\'imero PMC300 (Ver Figura \ref{PMC}) est\'a basado en el mon\'omero 4,7-bis[2-(9,9-dimethyl)fluorenyl]benzo[1,2,5]thiadiazole, la s\'intesis se reporta en la referencia \cite{laura}. 
...
\subsection{Recubrimiento de nanopart\'iculas con PEG}

Los dos tipos de PEG utilizados, por sus propiedades anfif\'ilicas, sustituyeron el surfactante. Ambos PEG tienen grupos funcionales, como el grupo alquilo, carbonilo e hidroxilo en el caso del PEG 5000 y grupos carbonilo en el PEG 2000 (Ver Figura \ref{pegs}); al utilizarlos para recubrir las nanopart\'iculas, se modifica la superficie de las mismas y se lleva a cabo una funcionalizaci\'on.
