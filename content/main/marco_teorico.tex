...
Es posible comprender este fen\'omeno analizando el patr\'on de difracci\'on (de varios \'ordenes) que se forman cuando un haz de luz atraviesa un \emph{pinhole} o abertura circular como se muestra en la figura \ref{difra}. Para obtener la informaci\'on completa o detalles de la muestra, las lentes del objetivo colectan la luz proveniente de todos los \'ordenes de difracci\'on. Entre m\'as grande sea el cono de luz que llega al objetivo de microscopio, m\'as \'ordenes de difracci\'on pueden colectar las lentes y la resoluci\'on del objetivo aumenta. 


\begin{figure}[ht]
\centering
\includegraphics[width=0.7\textwidth]{marco_teorico/airydisk}
\caption{Distribuci\'on de intensidad de un haz de luz y patr\'on de difracciÛn conocido como \emph{Airy Disk} \label{difra}}   %http://microscopy.berkeley.edu/courses/tlm/2P/index.html 
\end{figure}
...
\begin{figure}[ht]
\centering
\includegraphics[width=3.2in, height=2.5in]{marco_teorico/micrfluor}
\caption[Principio b\'asico de microscopio de epifluorescencia.]{Principio b\'asico de microscopio de epifluorescencia. \emph{\scriptsize{Imagen obtenida de http://www.nobelprize.org/educational/physics/microscopes/fluorescence/, sin datos de autor.}} \label{epi}}   
\end{figure}
...
\begin{figure}
\centering
\includegraphics[width=0.95\textwidth]{marco_teorico/confocal2}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.7\textwidth]{marco_teorico/compara}
\caption[Haz de excitaci\'on para microscop\'ia de barrido l\'aser de uno y dos fotones.]{Haz de excitaci\'on para microscop\'ia de barrido l\'aser de uno y dos fotones. \emph{\scriptsize{Imagen de  Steve Ruzin y Holly Aaron, UC Berkeley.}}\label{puntual}}   %http://microscopy.berkeley.edu/courses/
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=4.2in, height=2.2in]{marco_teorico/tpa1}
\caption[Diagrama de energ\'ia para la transici\'on de uno y dos fotones.]{Diagrama de energ\'ia para la transici\'on de uno y dos fotones. \emph{\scriptsize{Imagen de D. Nowak}} 
 \label{diagramatpa}}    
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=4.5in, height=2.2in]{marco_teorico/penetrasyo}
\caption[Esquema de penetraci\'on del tejido a diferentes longitudes de onda.]{Esquema de penetraci\'on del tejido a diferentes longitudes de onda. \emph{\scriptsize{Imagen tomada del artÌculo "The Impact of Near-infrared in Plastic Surgery", Ibima Publishing.}} \label{penetrad}}    
\end{figure}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.6\textwidth]{marco_teorico/tercerorden}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.34\textwidth]{marco_teorico/gra2}
...
\subsection{Medici\'on de \texorpdfstring{$\sigma^{TPA}$}{sigmaTPA} mediante la t\'ecnica de TPEF}
...
\subsection[Transferencia de Energ\'ia de Resonancia F\"orster]{Transferencia de Energ\'ia de Resonancia F\"orster\\ (FRET)\label{fretis}}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.5\textwidth]{marco_teorico/fret}
\caption{{Esquema de la Transferencia de Energ\'ia de Resonancia F\"orster}\label{fretito}}   
\end{figure}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.6\textwidth]{marco_teorico/overlap}
